          ...
          ListView(
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 120, 43, 219).withOpacity(0.2),
                  ...
                  child: Container(
                    ...
                    height: 100,
                    width: 100,
                    child: Image.asset('Assets/huruf A.png', height: 50),
                  ),
                )
              ),
              SizedBox(height: 20),
              Row(
                ...
                children: [
                  TextFrave(text: 'Andi Developer', fontSize: 20, fontWeight: FontWeight.w500 ),
                  SizedBox(width: 5),
              ...
              _ItemProfile(
                ...
                onPressed: () async {
                  var url = await canLaunch('https://github.com/GreenDay027');
                  if( url ){
                    await launch('https://github.com/GreenDay027');
                  }
                },
              ),
              _ItemProfile(
                ...
                iconRight: Icons.open_in_new_rounded,
                onPressed: () async {
                  var url = await canLaunch('https://www.youtube.com/channel/UCTErnvEDwuCB3bcLfaEpsuQ');
                  if( url ){
                    await launch('https://www.youtube.com/channel/UCTErnvEDwuCB3bcLfaEpsuQ');
                  }
                },
              ),
